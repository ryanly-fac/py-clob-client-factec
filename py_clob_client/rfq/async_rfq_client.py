"""
Async RFQ (Request for Quote) client for the Polymarket CLOB API.

This module provides the AsyncRfqClient class which handles all RFQ operations
including creating requests, quotes, and executing trades asynchronously.
"""
...
from ..http_helpers.helpers import async_get, async_post, async_delete
...
class AsyncRfqClient:
    """
    Async RFQ client for creating and managing RFQ requests and quotes.
    ...
    This client is typically accessed via the parent AsyncClobClient's `rfq` attribute:
        ...
        response = await client.rfq.create_rfq_request(user_request)
    """

    def __init__(self, parent: "AsyncClobClient"):
        """
        Initialize the Async RFQ client.
    ...
    async def create_rfq_request(
        ...
        Example:
            >>> response = await client.rfq.create_rfq_request(
            ...     RfqUserRequest(
            ...         token_id="123...",
            ...         price=0.5,
            ...         side="BUY",
        ...
        return await async_post(self._build_url(CREATE_RFQ_REQUEST), headers=headers, data=serialized_body)
    ...
    async def cancel_rfq_request(self, params: CancelRfqRequestParams) -> str:
        ...
        return await async_delete(self._build_url(CANCEL_RFQ_REQUEST), headers=headers, data=serialized_body)
    ...
    async def create_rfq_quote(
        ...
        Example:
            >>> response = await client.rfq.create_rfq_quote(
            ...     RfqUserQuote(
        ...
        return await async_post(self._build_url(CREATE_RFQ_QUOTE), headers=headers, data=serialized_body)

    async def get_rfq_requester_quotes(self, params: Optional[GetRfqQuotesParams] = None) -> dict:
        """
    ...
    async def get_rfq_quoter_quotes(self, params: Optional[GetRfqQuotesParams] = None) -> dict:
        """
    ...
    async def cancel_rfq_quote(self, params: CancelRfqQuoteParams) -> str:
        ...
        return await async_delete(self._build_url(CANCEL_RFQ_QUOTE), headers=headers, data=serialized_body)
    ...
    async def rfq_config(self) -> dict:
        ...
        return await async_get(self._build_url(RFQ_CONFIG), headers=headers)
