...
from .rfq import AsyncRfqClient
...
class AsyncClobClient:
    def __init__(
        ...
        """
        Initializes the async clob client
        ...
        configure_http_clients(proxies=proxies, host=self.host)
    ...
    async def get_ok(self):
        ...
        """
        return await async_get("{}/".format(self.host))
    ...
    async def get_server_time(self):
        ...
        Does not need authentication
        """
        return await async_get("{}{}".format(self.host, TIME))
    ...
    async def create_api_key(self, nonce: int = None) -> ApiCreds:
        ...
        creds_raw = await async_post(endpoint, headers=headers)
        try:
            creds = ApiCreds(
    ...
    async def derive_api_key(self, nonce: int = None) -> ApiCreds:
        ...
        creds_raw = await async_get(endpoint, headers=headers)
        try:
            creds = ApiCreds(
                api_key=creds_raw["apiKey"],
                api_secret=creds_raw["secret"],
    ...
    async def get_api_keys(self):
        ...
        return await async_get("{}{}".format(self.host, GET_API_KEYS), headers=headers)
    ...
    async def get_closed_only_mode(self):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return await async_get("{}{}".format(self.host, CLOSED_ONLY), headers=headers)
    ...
    async def delete_api_key(self):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return await async_delete("{}{}".format(self.host, DELETE_API_KEY), headers=headers)
    ...
    async def create_readonly_api_key(self) -> ReadonlyApiKeyResponse:
        ...
        response = await async_post("{}{}".format(self.host, CREATE_READONLY_API_KEY), headers=headers)
        try:
    ...
    async def get_readonly_api_keys(self) -> list[str]:
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return await async_get("{}{}".format(self.host, GET_READONLY_API_KEYS), headers=headers)
    ...
    async def get_midpoint(self, token_id):
        ...
        """
        return await async_get("{}{}?token_id={}".format(self.host, MID_POINT, token_id))
    ...
    async def get_midpoints(self, params: list[BookParams]):
        ...
        return await async_post("{}{}".format(self.host, MID_POINTS), data=body)

    async def get_price(self, token_id, side):
        """
        Get the market price for the given market
        """
        return await async_get("{}{}?token_id={}&side={}".format(self.host, PRICE, token_id, side))
    ...
    async def get_prices(self, params: list[BookParams]):
        ...
        return await async_post("{}{}".format(self.host, GET_PRICES), data=body)

    async def get_spread(self, token_id):
        """
        Get the spread for the given market
        """
        return await async_get("{}{}?token_id={}".format(self.host, GET_SPREAD, token_id))
    ...
    async def get_spreads(self, params: list[BookParams]):
        ...
        """
        body = [{"token_id": param.token_id} for param in params]
        return await async_post("{}{}".format(self.host, GET_SPREADS), data=body)

    async def get_tick_size(self, token_id: str) -> TickSize:
        if token_id in self.__tick_sizes:
            return self.__tick_sizes[token_id]

        result = await async_get("{}{}?token_id={}".format(self.host, GET_TICK_SIZE, token_id))
    ...
    async def get_neg_risk(self, token_id: str) -> bool:
        ...
        result = await async_get("{}{}?token_id={}".format(self.host, GET_NEG_RISK, token_id))
    ...
    async def get_fee_rate_bps(self, token_id: str) -> int:
        ...
        result = await async_get("{}{}?token_id={}".format(self.host, GET_FEE_RATE, token_id))
    ...
    async def cancel_all(self):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return await async_delete("{}{}".format(self.host, CANCEL_ALL), headers=headers)
    ...
    async def get_order_book(self, token_id) -> OrderBookSummary:
        ...
        """
        raw_obs = await async_get("{}{}?token_id={}".format(self.host, GET_ORDER_BOOK, token_id))
    ...
    async def get_order_books(self, params: list[BookParams]) -> list[OrderBookSummary]:
        ...
        """
        body = [{"token_id": param.token_id} for param in params]
        raw_obs = await async_post("{}{}".format(self.host, GET_ORDER_BOOKS), data=body)
    ...
    async def get_order(self, order_id):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return await async_get("{}{}".format(self.host, endpoint), headers=headers)
    ...
    async def get_last_trade_price(self, token_id):
        ...
        """
        return await async_get("{}{}?token_id={}".format(self.host, GET_LAST_TRADE_PRICE, token_id))
    ...
    async def get_last_trades_prices(self, params: list[BookParams]):
        ...
        """
        body = [{"token_id": param.token_id} for param in params]
        return await async_post("{}{}".format(self.host, GET_LAST_TRADES_PRICES), data=body)
    ...
    async def drop_notifications(self, params: DropNotificationParams = None):
        ...
        return await async_delete(url, headers=headers)
    ...
    async def get_markets(self, next_cursor="MA=="):
        ...
        """
        return await async_get("{}{}?next_cursor={}".format(self.host, GET_MARKETS, next_cursor))
    ...
    async def get_market(self, condition_id):
        ...
        """
        return await async_get("{}{}{}".format(self.host, GET_MARKET, condition_id))

    async def get_market_trades_events(self, condition_id):
        """
        Get the market's trades events by condition id
        """
        return await async_get("{}{}{}".format(self.host, GET_MARKET_TRADES_EVENTS, condition_id))
